...
--------------------------------------------------------------------------------
-- type for JSON Array
type JSONArray is table of varchar2(20000) index by binary_integer;

-- type for all Name/Value Couples in JSON
type gr_JSONnvCouple is record (name varchar2(255), value varchar2(20000));
...
type JSONItem is record ( type varchar2(100),  -- OPENBRACE, OPENHOOK, CLOSEBRACE, CLOSEHOOK, 
											   ...
											   -- INDENTATION
	 		  	 		  item varchar2(20000), -- the attribute name or value.
...
g_indent varchar2(20000) := null;  -- count the recursive imbrications for object 
