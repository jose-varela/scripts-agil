CREATE OR REPLACE FUNCTION PRC_TABELAS_RECEBIDAS(V_POSTO            IN TABELAS_RECEBIDAS.POSTO%TYPE,
                                                  ...
                                                  V_CONTEUDO0        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO1        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO2        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO3        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO4        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO5        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO6        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO7        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO8        IN VARCHAR(4000)(2000),
                                                  V_CONTEUDO9        IN VARCHAR(4000)(2000),
